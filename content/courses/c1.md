...
```
In the out put there were no missing values. 
...
plt.ylabel('Count')
```
![distribution_of_obesity.png](distribution_of_obesity.png)
...
![confusion_matrix_training_set.png](confusion_matrix_training_set.png)
